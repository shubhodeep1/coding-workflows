...
| `WORKFLOW_RETRO_SKIP_IF_NO_ACTIVITY` | `true` | Skip the weekly retro LLM pass and tracker comment (log-only `WORKFLOW_RETRO_SKIP_V1` line) when the window had zero workflow runs and zero merged PRs |
