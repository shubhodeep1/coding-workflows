...
- Prompt assembly is cache-friendly in all Codex-driven phases: static prefix first (`codex_system_instructions.md` + `agents.md` + phase template), dynamic context second (memory context, issue/PR body, comments/diffs).
