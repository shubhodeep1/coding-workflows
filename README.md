...
| `MAX_STALL_RECOVERIES_PER_ISSUE` | `5` | Max stall recovery attempts per issue before skipping (declarative `STALL_RECOVERY_ACTIONS`: two same-phase retries, then `escalate_human`; optional `run_stall_judge` escalation) |
