...
The terminal `Project security pass exhausted` tracking comment includes the remaining findings table (the same rows a fix issue would carry), since the findings file exists only on the runner.
