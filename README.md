...
- The same partial path persists `.ai/review_runtime/pr-<PR>/round-<N>/partial_finalize.json` alongside the usual ledger/runtime cache so a later resume/no-progress consumer can continue from structured state instead of parsing prose.
