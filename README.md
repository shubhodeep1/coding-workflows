...
15. **Completion:** When validation is disabled, completion follows a successful default-on SHA-bound security pass. Setting `ENABLE_SECURITY_PASS=false` restores the legacy judge-driven immediate route.
