...
- Reviewer stall recovery is greppable in raw logs as `codex_stall_killed` plus `REVIEWER_ADVANCE:`; the structured summary is the durable end-of-run record for those same events.
