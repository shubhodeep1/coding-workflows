...
| `ENABLE_STALL_HUMAN_TERMINALIZATION` | No | `false` | orchestrate_poll | Legacy compatibility flag for terminal stall escalation policy selection in recovery ladder resolution (`escalate_human`). |
...
| `ENABLE_STALL_HUMAN_TERMINALIZATION` | `false` | Legacy compatibility flag for terminal stall escalation policy selection in ladder resolution |
