...
| `MAX_POST_CODEX_REPAIR_ATTEMPTS` | No | `1` | implement | Reserved for a future in-place post-Codex repair retry loop. Current branch behavior does not consume this variable and performs no in-place repair retries before the diagnose/fix-up fallback. |
...
| `MAX_POST_CODEX_REPAIR_ATTEMPTS` | `1` | Reserved for future in-place post-Codex repair retries; currently ignored by this branch |
