...
5. **Codex settings** — model `openai/gpt-5.4`, no timeout, search off (match `review_autofix.yml` settings). `unattended_system_instructions.md` included in context for every phase.
