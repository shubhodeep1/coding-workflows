...
Mixed-author V2 chains cannot assemble. If authenticated-user resolution fails, state input is rejected and the tracking issue safely pauses for that poll cycle instead of reconstructing state or performing state-driven repository mutations.
