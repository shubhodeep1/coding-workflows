...
What this means for operators: review runs on integration-branch PRs succeed again without any manual action. Main-target PRs still use Codex for reviewer and editor execution, but their review jobs now also perform the OpenCode install and cache warm, adding setup time and a network-dependent preflight.
