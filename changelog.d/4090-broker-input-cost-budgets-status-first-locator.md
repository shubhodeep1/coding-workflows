...
| --- | --- |
| Default per-request input-token ceiling | `4194304` (16 MiB body cap / 4 bytes per token) |
| Default total input-token budget | `419430400` (100 requests x 4194304) |
| Default total cost budget | derived: both token budgets at the price ceilings + 100 x request price |
