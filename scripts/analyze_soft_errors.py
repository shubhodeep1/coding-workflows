...
window, then asks an OpenRouter chat model (default openai/gpt-6-luna at
...
# context-window limit (gpt-6-luna = 1.05M tokens); on overflow the
...
def main() -> int:
	...
	parser.add_argument(
		"--model",
		default=os.environ.get("LOG_ANALYZER_MODEL", "openai/gpt-6-luna"),
	)
	parser.add_argument(
		"--reasoning",
