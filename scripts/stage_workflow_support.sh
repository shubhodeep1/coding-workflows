...
MAIN_PRIMARY_BOOTSTRAP_SCRIPTS="verify_integration_fingerprints.py review_collect_pr_metadata.sh files_touched_scope_guard.py review_commit_changes.sh review_conflict_prepare.sh review_conflict_resolve.sh review_rb_judge.sh render_prompt.py opencode_helpers.sh untrusted_process_sandbox.sh model_provider_proxy.py package_download_proxy.py write_opencode_config.sh"
