...
declare -A _AI_LABEL_DESCS=(
	...
	["ai:resolver-escalated"]="Integration conflict resolver hit the escape threshold; orchestrator redispatch is paused until PR head changes"
	...
	["ai:scope-blocked"]="Implementation commit was refused for staging files outside the declared files_touched allowlist — redispatch of this issue ID is blocked pending human review"
