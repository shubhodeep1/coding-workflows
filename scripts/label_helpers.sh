...
set_issue_phase_label_resilient() {
	...
	local phase_labels='["ai:done","ai:implementing","ai:validating","ai:validated","ai:validation-failed","ai:validation-fixing","ai:validation-recovery","ai:awaiting-approval","ai:planning","ai:clarification","ai:ready-to-merge","ai:review-blocked","ai:implementation-failed","ai:needs-human","ai:blocked","ai:merged","ai:closed","ai:clarify-failed","ai:clarify-respond-failed","ai:plan-failed","ai:implement-diagnose-failed","ai:review-autofix-failed","ai:validate-failed","ai:integration-judge-failed","ai:log-analysis-failed","ai:memory-maintenance-failed","ai:comprehensive-test-pending","ai:destructive-blocked","ai:implement-fix-up","ai:needs-prompt-review"]'
	local cur_labels=""
	local new_labels=""
