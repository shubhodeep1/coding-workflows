...
declare -A _AI_LABEL_DESCS=(
	...
	["ai:resolver-escalated"]="Integration resolver hit escape threshold; redispatch pauses until PR head changes"
	...
	["ai:destructive-blocked"]="Implementation blocked for mass/destructive deletions; redispatch waits for human review"
