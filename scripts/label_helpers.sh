...
declare -A _AI_LABEL_DESCS=(
	...
	["ai:resolver-escalated"]="Resolver escape threshold reached; orchestrator redispatch waits for a new PR head"
	...
	["ai:destructive-blocked"]="Mass/destructive deletions blocked; issue redispatch waits for human review"
