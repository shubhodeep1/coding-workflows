...
# depending on which failure mode they need to suppress. Reference-placeholder
# fail-open requires both flags. Placeholder substitution for the static
# scaffolding still runs. Default (unset) keeps
