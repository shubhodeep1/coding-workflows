...
- `scripts/untrusted_process_sandbox.sh` is the mandatory boundary for planner,
  ...
  roots fail closed, and forwarded artifacts are regular-file/symlink checked
  before they cross back to the host runtime.
