...
- Stall-recovery compatibility controls in this repo: `ENABLE_STALL_HUMAN_TERMINALIZATION` (default `false`). Keep default behavior backward-compatible: non-human terminal fallback unless explicitly opted in.
