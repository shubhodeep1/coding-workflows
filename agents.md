...
| `CI_POLL_TEST_SHARDS` | `4` | Parallel shards for the orchestrate-poll module in `CI / lint`. `1` is sequential; invalid values warn and fall back to `1`. |
