...
default `openai/gpt-6-luna`) to extract semantic keywords from the issue before scoring.
...
- `AI_MEMORY_KEYWORD_MODEL` (default `openai/gpt-6-luna`) — model for semantic keyword extraction
