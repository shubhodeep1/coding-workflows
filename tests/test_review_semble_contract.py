...
def test_workflow_bootstrap_and_runtime_defaults_wire_semble_and_serena() -> None:
	...
	# index/query CLI). render_prompt.py also stays optional so shim-adopting
	# branches can stage the Python backend beside render_prompt.sh without
	# breaking main-based callers.
