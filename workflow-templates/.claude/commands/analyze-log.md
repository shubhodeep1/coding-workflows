...
- **Prefer `mcp__github__*` for GitHub reads; fall back to the `gh` CLI + `GH_TOKEN` when the MCP surface is awkward or scope-gated (CLAUDE.md §23.D)** (see [Tool Access](#tool-access)).
